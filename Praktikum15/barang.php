        ...
        <div class="row">
            ...
            <div class="col-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        <button type="button" class="btn btn-primary mb-3 mt-2" data-bs-toggle="modal" data-bs-target="#ModalTambah">Tambah Data Barang</button>
                        <!-- modal tambah -->
                                    ...
                                    <form action="proses/proses_tambah_barang.php" method="POST" enctype="multipart/form-data">
                                        <div class="modal-body">
                                            <div class="form-floating mb-3">
                                                <input type="number" class="form-control" name="kode_barang" id="floatingInput" autofocus>
                                                <label for="floatingInput">Kode Barang</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control" name="nm-brg" id="floatingInput" autofocus>
