        ...
        <div class="row">
            ...
            <div class="col-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        <button type="button" class="btn btn-primary mb-3 mt-2" data-bs-toggle="modal" data-bs-target="#ModalTambahPeminjaman">Tambah Peminjaman</button>
                        <button type="button" class="btn btn-primary mb-3 mt-2" data-bs-toggle="modal" data-bs-target="#ModalListPeminjaman">List Peminjaman</button>
                        <!-- modal tambah -->
                        <div class="modal fade" id="ModalTambahPeminjaman" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <form action="proses/proses_tambah_peminjaman.php" method="POST" enctype="multipart/form-data">
                                        <div class="modal-body">
                                            ...
                                            <div class="form-floating mb-3">
                                                <input type="datetime-local" class="form-control" name="waktu_pengembalian" id="floatingInput">
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            elseif ($query['status'] == 4) echo "<span class='badge bg-primary'>Dikembalikan</span>";
                                                            ?>
                                                        </td>
                                                        <td>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        <th scope="row"><?= $no ?></th>
                                        <td><?= $query['kode_barang'] ?></td>
                                        <td><img src="<?= "images/barang/" . $query['gambar_barang']; ?>" width="100" height="100" class="rounded mb-1" alt="..."></td>
                                        <td><?= $query['nama_barang'] ?></td>
                                        ...
                                        <td>
                                            <?php
                                            if ($query['status'] == 1 or $query['status'] == 2) $s = "disabled";
                                            else $s = "";
                                            ?>
