...
<div class="d-flex flex-column flex-shrink-0 p-3 bg-light" style="width: 280px;">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
        ...
        <?php
        if ($row['level'] == 'mahasiswa' or $row['level'] == "admin") {
        ?>
        <li>
            <a href="pinjam" class="nav-link link-dark
                <?php if ($_GET['x'] == 'pinjam')  echo 'active'; ?>
                ">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    class="bi bi-bag-check-fill me-2" viewBox="0 0 16 16">
                    <path fill-rule="evenodd"
        ...
        ?>
        <li>
            <a href="data_pinjaman" class="nav-link link-dark 
                <?php if ($_GET['x'] == 'data_pinjaman')  echo 'active'; ?>
                ">
                <svg class="bi me-2" width="16" height="16">
        ...
        <hr>
        <li>
            <a href="tdm" class="nav-link link-dark
                <?php if ($_GET['x'] == 'tdm')  echo 'active'; ?>
                ">
                <svg class="bi me-2" width="16" height="16">
                    <use xlink:href="#people-circle" />
                </svg>
