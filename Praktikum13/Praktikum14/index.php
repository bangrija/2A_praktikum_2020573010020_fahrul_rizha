...
if (empty($_GET['x'])) {
    ...
    $link = array("home" => "home.php", "pinjam" => "pinjam.php", "mahasiswa" => "mahasiswa.php", "data_peminjaman" => "data_peminjaman.php", "barang" => "barang.php", "dosen" => "dosen.php", "tdm" => "tdm.php", "profile" => "profile.php", "setting" => "setting.php");
