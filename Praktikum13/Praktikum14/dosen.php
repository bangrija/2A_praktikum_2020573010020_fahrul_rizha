                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <button type="button" class="btn btn-primary mb-3 mt-2" data-bs-toggle="modal"
                            data-bs-target="#ModalTambah">Tambah Data Dosen</button>
                        <!-- modal tambah -->
                        <div class="modal fade" id="ModalTambah" tabindex="-1" aria-labelledby="exampleModalLabel"
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <form action="proses/proses_tambah_dosen.php" method="POST"
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            <button type="button" class="btn btn-success" name="detail"
                                                ...
                                                data-bs-target="#ModalDetail<?= $query['nip']; ?>">
                                            ...
                                            <button type="button" class="btn btn-primary ms-2" name="edit"
                                                data-bs-toggle="modal" data-bs-target="#ModalEdit<?= $query['nip']; ?>">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            ...
                                            <button type="button" class="btn btn-danger ms-2" name="delete"
                                                data-bs-toggle="modal"
                                                data-bs-target="#ModalDelete<?= $query['nip']; ?>">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                    ...
                                    <!-- modal edit -->
                                    <div class="modal fade" id="ModalEdit<?= $query['nip']; ?>" tabindex="-1"
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="proses/proses_edit_dosen.php" method="POST"
                                                        enctype="multipart/form-data">
                                                        <div class="row">
                                                            <div class="col">
                                                                <input type="hidden" name="id_user"
                                                                    value="<?= $query['id_user'] ?>">
                                                                <input type="hidden" name="niplama"
                                                                    value="<?= $query['nip'] ?>">
                                                                <div class="form-floating mb-2">
                                                                    <input type="number" class="form-control"
                                                                        name="nipbaru" id="floatingInput"
                                                                        value="<?= $query['nip'] ?>">
                                                                    <label for="floatingInput">NIP</label>
                                                                </div>
                                                            </div>
                                    ...
                                    <!-- modal hapus -->
                                    <div class="modal fade" id="ModalDelete<?= $query['nip']; ?>" tabindex="-1"
                                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    ...
                                    <!-- modal detail -->
                                    <div class="modal fade" id="ModalDetail<?= $query['nip']; ?>" tabindex="-1"
                                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-sm">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="card">
                                                        <img src="<?= "images/dosen/" . $query['gambar']; ?>"
