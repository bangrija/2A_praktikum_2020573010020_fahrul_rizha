            ...
            if (isset($hasil['nip'])) {
                ...
                if ($tambah_user) {
                    ...
                    if ($cek_id) {
                        ...
                        $tambah_dosen = mysqli_query($conn, "INSERT INTO `tb_dosen` (`nip`, `id_user`, `nama`, `jurusan`, `prodi`, `alamat`, `tgl_lahir`, `tempat_lahir`, `gambar`) VALUES ('$nip', '$id_user', '$nama', '$jurusan', '$prodi', '$alamat', " . ($tanggal_lahir == NULL ? "NULL" : "'$tanggal_lahir'") . ", '$tempat_lahir', '$nama_gambar')");
