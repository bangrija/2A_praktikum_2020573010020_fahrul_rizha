            ...
            if (isset($hasil['nim'])) {
                ...
                if ($tambah_user) {
                    ...
                    if ($cek_id) {
                        ...
                        $tambah_mahasiswa = mysqli_query($conn, "INSERT INTO tb_mahasiswa (nim, id_user, nama, kelas, prodi, alamat, tgl_lahir, tempat_lahir, gambar) VALUES ('$nim', '$id_user', '$nama', '$kelas', '$prodi', '$alamat', " . ($tanggal_lahir == NULL ? "NULL" : "'$tanggal_lahir'") . ", '$tempat_lahir', '$nama_gambar')");
